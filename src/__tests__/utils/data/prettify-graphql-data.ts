type GraphqlPretifyData = { query: string; expected: string };

export const ERR_MESSAGE = 'Error: Syntax Error: Unexpected Name';
export const graphqlPretifyData: GraphqlPretifyData[] = [
  {
    query: '',
    expected: '',
  },
